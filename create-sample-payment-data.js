    ...
    const samplePayments = [
      {
        ...
        transaction_id: 'TXN_TalyerOTG_001_' + Date.now(),
        status: 'completed',
      ...
      },
      {
        ...
        payment_method: 'maya',
        payment_gateway: 'paymongo',
        transaction_id: 'TXN_TalyerOTG_002_' + Date.now(),
        status: 'in_escrow',
      ...
      },
      {
        ...
        transaction_id: 'TXN_TalyerOTG_003_' + Date.now(),
        status: 'processing',
        processed_at: null,
        payment_verification_required: false,
        verification_status: 'not_required',
      ...
      },
      {
        ...
        payment_gateway: 'paymongo',
        transaction_id: 'TXN_TalyerOTG_004_' + Date.now(),
        status: 'failed',
      ...
      },
      {
        ...
        transaction_id: 'TXN_TalyerOTG_005_' + Date.now(),
